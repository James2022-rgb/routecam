...
/// centred on `current_fix`, the full capture's track polyline (with
/// the already-driven part highlighted up to `current_pts_seconds`),
/// a position marker, the mandatory "(c) OpenStreetMap" attribution,
